...
import { Property, Structure, StructureMeta, ObservableAdmin } from './types.js';
...
if (!getGlobal()[$lib]) {
  ...
  lib.untracked = false;
  lib.action = false;
  lib.queue = new Set<ObservableAdmin>();
...
export const executor: typeof Executor = lib.executor;